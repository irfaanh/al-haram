        ...
        <div className="flex flex-col gap-8">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 overflow-y-auto">
                    <div className="bg-zinc-900 border border-white/10 rounded-xl w-full max-w-2xl relative flex flex-col max-h-[90vh]">
                            ...
                            <form id="course-form" onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="relative">
                                                ...
                                                />
                                                <button type="button" className={`px-4 py-2 bg-zinc-800 border border-zinc-700 rounded-md text-sm hover:bg-zinc-700 ${isUploading ? 'opacity-50' : ''}`}>
                                ...
                                <div className="space-y-4 border-t border-white/10 pt-4">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <button type="button" onClick={addModule} className="text-xs bg-[#BE5103]/20 text-[#BE5103] px-2 py-1 rounded hover:bg-[#BE5103]/30">
                                            + Add Module
                                        </button>
                                    </div>
                        ...
                        <div className="p-4 border-t border-white/10 flex justify-end gap-2 bg-zinc-900 rounded-b-xl">
                            <button onClick={resetForm} className="px-4 py-2 text-sm text-gray-400 hover:text-white">Cancel</button>
                            <button
                                form="course-form"
                                type="submit"
                                className="px-4 py-2 bg-[#BE5103] rounded-md text-sm font-medium hover:bg-[#BE5103]/90"
                            >
                        ...
                        <div className="p-4">
                            <div className="flex items-start justify-between">
                                ...
                                <div className="flex gap-1">
                                    <button onClick={() => handleEdit(course)} className="p-1 hover:text-[#BE5103] text-gray-400">
                                        <Edit className="size-4" />
                                    </button>
                                    <button onClick={() => handleDelete(course.id)} className="p-1 hover:text-red-500 text-gray-400">
                                        <Trash2 className="size-4" />
                                    </button>
                                </div>
                            </div>
