...
export default function TeamSlider() {
    ...
    return (
        <div className="relative group">
            {/* Navigation Arrows - Visible only on mobile/small screens by default or can be always on for touch */}
            <div className="flex md:hidden absolute -bottom-12 left-1/2 -translate-x-1/2 z-20 items-center gap-6">
                <button
                    onClick={() => scroll("left")}
                    className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center bg-black/50 backdrop-blur-sm text-white hover:bg-[#BE5103] hover:border-[#BE5103] transition-all"
